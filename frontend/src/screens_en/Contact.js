...
const Contact = () => {
  ...
  useEffect(() => {
    if (id) {
      window.history.pushState({}, document.title, "/contact/en");
    }
  }, [id]);
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    setIsloaded(true);
    fetch(process.env.REACT_APP_BACKEND_URL + "api/intlsecure/sendmail", {
      method: "POST",
      credentials: "include",
          ...
          <section className="contactUs container-fluid">
            <div className="container">
                ...
                <div className="find">
                  ...
                  {user.isLoggedIn ? (
                    user.isTeacher ? (
                      ...
                      <Link to="/step1/en">Register</Link>
                    )
                  ) : (
                    <Link to="/signup/en">Register</Link>
                  )}
                </div>
              </div>
              <div className="contactBottom">
                ...
                <p>
                  Landline : <span>07 - 552 2251</span>
                </p>
                <p>
                  Email us : <span>hello@acabook.com.tw</span>
                </p>
              </div>
            </div>
          </section>
