...
const Step2 = () => {
  ...
  useEffect(() => {
    ...
    if (!ReactSession.get("workhistory")) {
      setWorkhistory("Tutoring Experiences");
    } else {
    ...
    if (!ReactSession.get("honourTitle")) {
      setHonourTitle("Teaching Honours & Awards");
    } else {
  ...
  const [talen] = useState([
    ...
    { title: "Taiwanese - 台語 閩南語", id: 2 },
    { title: "Cantonese - 粵語 廣東話", id: 3 },
    { title: "Arabic - 阿拉伯語", id: 4 },
    { title: "Dutch - 荷蘭語", id: 5 },
    { title: "English - 英語", id: 6 },
    { title: "French - 法語", id: 7 },
    { title: "German - 德語", id: 8 },
    { title: "Greek - 希臘語", id: 9 },
    { title: "Indonesian - 印尼語", id: 10 },
    { title: "Italian - 義大利語", id: 11 },
    { title: "Japanese - 日語", id: 12 },
    { title: "Korean - 韓語", id: 13 },
    { title: "Persian - 波斯語", id: 14 },
    { title: "Polish - 波蘭語", id: 15 },
    { title: "Portuguese - 葡萄牙語", id: 16 },
    { title: "Russian - 俄語", id: 17 },
    { title: "Spanish - 西班牙語", id: 18 },
    { title: "Thai - 泰語", id: 19 },
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Tutor Registration Step 2 | Acabook</title>
