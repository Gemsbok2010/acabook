...
const Dashboard = () => {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Dashboard Home | Acabook</title>
          ...
          <main>
            ...
            <aside className={close ? "moveback" : "movehere"}>
              ...
              {user.isActive === false || user.completeAccess === false ? (
                ...
                <div className="sidebar">
                  <Link to="/dashboard/en" className="active">
                    <span className="material-icons-sharp">dashboard</span>
                    <h4>Dashboard Home </h4>
                  </Link>
                  <Link to="/personal-details/en">
                  ...
                  {user.isTeacher ? (
                    <Link to="/teacher_profile/en">
                      <span className="material-icons-sharp">person</span>
                      <h4>Manage Tutor Profile</h4>
                    </Link>
                  ) : (
                    <Link to="/step1/en">
                      <span className="material-icons-sharp">person</span>
                  ...
                  <Link to="/searchlist/en">
                    <span className="material-icons-sharp">search</span>
                    <h4>Search Job Cases</h4>
                  </Link>
                  <Link to="/applicationsManager/en">
                    <span className="material-icons-sharp">search</span>
                    <h4>Applications Manager</h4>
                  </Link>
                  <div style={{ borderBottom: "2px solid #1A1A1A" }}>
                  ...
                  <Link to="/teacherdatabase/en">
                    <span className="material-icons-sharp">person_search</span>
                    <h4>Tutor Database</h4>
                  </Link>
                  {!contractType ? (
                    <Link to="/question1/en">
            ...
            <section className="middle">
              {user.isActive === true ? (
                ...
                >
                  <span>
                    {" "}
                    Your account is blocked. Please contact Acabook customer
              ...
              {user.completeAccess === true ? (
                ...
                >
                  <span>
                    ...
                    left panel in order to fully access Acabook's services.
                  </span>
                </div>
              )}
              {messageOn === false ? (
                ...
                <div className="leftBox">
                  ...
                  {user.isTeacher === false ? (
                    <div className="bottomBox-none">
                      ...
                      <div>
                        <button type="button" className="registerTeacher">
                          <Link to="/step1/en">Register as a Tutor</Link>
                        </button>
                      </div>
                    </div>
                  ) : (
                    <div className="bottomBox">
                      <div>
                        <h2>Tutor Profile</h2>
                        <h4>Tutor ID: {ReactSession.get("teacherId")}</h4>
                        <h3>Name</h3>
                      ...
                      >
                        {ReactSession.get("currentState") === "台北市" ? (
                          <>
                            ...
                            <div>
                              <p>{ReactSession.get("tpe")}</p>
                              <p>{ReactSession.get("ntpe")}</p>
                              <p>{ReactSession.get("tao")}</p>
                              <p>{ReactSession.get("nationwide")}</p>
                            </div>
                          </>
