          ...
          <form action="" id="formFour" onSubmit={onSubmit}>
            <section className="questionCard container">
              ...
              <div className="btnGroup">
                {ReactSession.get("frequency") === "Once" ? (
                  <button
                    onClick={(e) => {
                ...
                {ReactSession.get("frequency") === "Twice" ? (
                  <button
                    onClick={(e) => {
                      setFrequency(e.target.innerText);
                    }}
                ...
                {ReactSession.get("frequency") === "3 times" ? (
                  <button
                    onClick={(e) => {
                      setFrequency(e.target.innerText);
                    }}
                ...
                {ReactSession.get("frequency") === "4 times" ? (
                  <button
                    onClick={(e) => {
                      setFrequency(e.target.innerText);
                    }}
                ...
                {ReactSession.get("frequency") === "5 times" ? (
                  <button
                    onClick={(e) => {
                      setFrequency(e.target.innerText);
                    }}
                ...
                {ReactSession.get("frequency") === "6 times" ? (
                  <button
                    onClick={(e) => {
                      setFrequency(e.target.innerText);
                    }}
              ...
              <div className="bottomBtn">
                {ReactSession.get("contractType") === "University" ? (
                  ...
                  <button className="btn-previous">
                    <Link to="/question3Level/en">Previous</Link>
                  </button>
                )}
              </div>
            </section>
