          ...
          <div className="wrapposter">
            <section className="passwordCard container">
              ...
              <div id="reasons" className="reasons">
                ...
                <label>Password needs to have minimum 6 characters</label>
            ...
            <section className="questionCard container">
                  ...
                  <div className="form-group">
                    ...
                    <div className="col-sm-8">
                      ...
                      <label htmlFor="gridCheck">
                        I have read and accept Acabook's{" "}
                        <Link to="/termsAndconditions/en">
                          Terms & Conditions
                        </Link>
                      </label>
                    </div>
              ...
              <p>
                Already have an account? <Link to="/login/en"> Login</Link>
              </p>
            </section>
          </div>
          <Footer />
