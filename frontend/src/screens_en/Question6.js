...
const Question6 = () => {
  ...
  const onSubmit = (e) => {
    ...
    fetch(process.env.REACT_APP_BACKEND_URL + "api/intllistings/question6", {
      method: "PUT",
      credentials: "include",
      ...
      .then((data) => {
        if (data.invalid) {
          ...
          navigate("/question7/en");
        }
      })
      .catch((err) => {
        if (err) {
          const errorMessage = `Hourly Rate needs to be at least NTD 100.`;
          ...
          <form action="" onSubmit={onSubmit}>
            <section className="questionCard container">
              ...
              <div className="btnGroup">
                ...
                <h2 className="intitule">Miscellaneous</h2>
                ...
                <div className="bottomBtn">
                  <button className="btn-previous">
                    <Link to="/question5/en">Previous</Link>
                  </button>
