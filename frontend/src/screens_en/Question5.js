          ...
          <form action="" id="formFive" onSubmit={onSubmit}>
            <section className="questionCard container">
              ...
              <div className="btnGroup">
                {ReactSession.get("duration") === "1 Hour" ? (
                  <button
                    onClick={(e) => {
                ...
                {ReactSession.get("duration") === "1.5 Hours" ? (
                  <button
                    onClick={(e) => {
                      setDuration(e.target.innerText);
                    }}
                ...
                {ReactSession.get("duration") === "2 Hours" ? (
                  <button
                    onClick={(e) => {
                      setDuration(e.target.innerText);
                    }}
                ...
                {ReactSession.get("duration") === "2.5 Hours" ? (
                  <button
                    onClick={(e) => {
                      setDuration(e.target.innerText);
                    }}
                ...
                {ReactSession.get("duration") === "3 Hours" ? (
                  <button
                    onClick={(e) => {
                      setDuration(e.target.innerText);
                    }}
              ...
              <div className="bottomBtn">
                <button className="btn-previous">
                  <Link to="/question4/en">Previous</Link>
                </button>
              </div>
            </section>
          </form>
