...
const Login = () => {
  ...
  const onSubmit = async (e) => {
    ...
    fetch(process.env.REACT_APP_BACKEND_URL + "api/auth/login", {
      ...
      .then((data) => {
        if (
          data.invalid === "Your account is registered in our English Website."
        ) {
          setBackdrop(true);
        }
        if (data.invalid) {
          ...
          <div className="wrapposter">
            <section className="questionCard container">
              ...
              <div className="container regCon">
                ...
                <p>
                  還沒有註冊嗎? <Link to="/signup">請註冊</Link>
                </p>
              </div>
            </section>
          </div>
          {backdrop ? (
            <>
              ...
              <div className="alertCard">
                ...
                <p>
                  We identified that your account is registered in our English
                  Website.
                </p>
                ...
                >
                  <Link to="/login/en">Continue</Link>
                </button>
              </div>
            </>
          ) : (
