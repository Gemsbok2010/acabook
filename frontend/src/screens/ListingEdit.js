...
const ListingEdit = () => {
  ...
  const onDelete = async (e) => {
    e.preventDefault();
    await fetch(process.env.BACKEND_URL + "api/listings/delete/" + list.slug, {
      method: "PUT",
      credentials: "include",
  ...
  const onSubmit = (e) => {
    ...
    fetch(process.env.BACKEND_URL + "api/listings/edit", {
      method: "PUT",
      credentials: "include",
      headers: { "Content-type": "application/json" },
      body: JSON.stringify({
            ...
            <div className="container-intro">
              <h2>
                ...
                {list.contractType === "大學" ? (
                  ...
                  <span className="highlight_school">{list.contractType}</span>
                  ...
                  <span className="highlight_music">{list.contractType}</span>
                )}
              </h2>
            ...
            <form action="" onSubmit={onSubmit}>
                    ...
                    <section className="questionCard container">
                      <div className="btnGroup">
                        <button
                          ...
                          className={frequency === "1 次" ? "active" : "btn"}
                        >
                          1 次
                        </button>
                        ...
                        <button
                          ...
                          className={frequency === "2 次" ? "active" : "btn"}
                        >
                          2 次
                        </button>
                        ...
                        <button
                          ...
                          className={frequency === "3 次" ? "active" : "btn"}
                        >
                          3 次
                        </button>
                        <button
                          ...
                          className={frequency === "4 次" ? "active" : "btn"}
                        >
                          4 次
                        </button>
                        ...
                        <button
                          ...
                          className={frequency === "5 次" ? "active" : "btn"}
                        >
                          5 次
                        </button>
                        <button
                          ...
                          className={frequency === "6 次" ? "active" : "btn"}
                        >
                          6 次
                        </button>
                      </div>
                    ...
                    <section className="questionCard container">
                      <div className="btnGroup">
                        <button
                          ...
                          className={duration === "1 小時" ? "active" : "btn"}
                        >
                          1 小時
                        </button>
                        <button
                          ...
                          className={duration === "1.5 小時" ? "active" : "btn"}
                        >
                          1.5 小時
                        </button>
                        <button
                          ...
                          className={duration === "2 小時" ? "active" : "btn"}
                        >
                          2 小時
                        </button>
                        <button
                          ...
                          className={duration === "2.5 小時" ? "active" : "btn"}
                        >
                          2.5 小時
                        </button>
                        <button
                          ...
                          className={duration === "3 小時" ? "active" : "btn"}
                        >
                          3 小時
                        </button>
                      </div>
              ...
              <div className="bottomButtons">
                ...
                sunFinish ? (
                  normal_rate !== "" ? (
                    monday && monFinish === "" ? (
                      <input disabled className="save-btn" value=" 儲存" />
                    ) : tuesday && tueFinish === "" ? (
                      <input disabled className="save-btn" value=" 儲存" />
                    ) : wednesday && wedFinish === "" ? (
                      <input disabled className="save-btn" value=" 儲存" />
