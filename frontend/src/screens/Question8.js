...
const Question8 = () => {
  ...
  useEffect(() => {
    if (!ReactSession.get("startDate")) {
      ...
      const mth = storedStartDate.split("月")[0];
      const dag = storedStartDate.split("日")[0];

      const year = storedStartDate.split("年")[0];
      const month = mth.split(" ")[1] - 1;

      const day = dag.split(" ")[2];
    ...
    if (!ReactSession.get("selectedFinishDay")) {
      ...
      const storedStartDate = ReactSession.get("finishDate");
      ...
      const day = dag.split(" ")[2];
      setSelectedFinishDay(new Date(year, month, day));
    }
  }, []);
  ...
  const onSubmit = (e) => {
    ...
    ReactSession.set(
      "finishDate",
      `${selectedFinishDay.getFullYear()}年 ${
        selectedFinishDay.getMonth() + 1
      }月 ${selectedFinishDay.getDate()}日`
    );
  ...
  function outPutErrorMessagesTimes(day) {
    ...
    const errorMessage = `${day}的下課時間不能比上課時間還要早, 請更正上下課時間.`;
    setAlertMsg(errorMessage);
  }

  // ========= HOURS OF WORK CALCULATIONS ===========
  const [, setMonHr] = useState("");
          ...
          <form action="" id="formEight" onSubmit={onSubmit}>
            <section className="questionCard container">
              ...
              <div className="btnGroup">
                <div className="selectdate">
                  <div className="contain">
                    <div className="day_picker">
                      <label htmlFor="demo-3_1">開始日期</label>
                      <input
                        className="calstart"
                        type="text"
                        readOnly
                    ...
                    <div className="day_picker">
                      <label htmlFor="demo-3_2">結束日期</label>
                ...
                <div id="timetable">
                  <h2 className="intitule">可以上課空擋時間</h2>
