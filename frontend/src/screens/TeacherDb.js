...
const TeacherDb = () => {
  ...
  const pagePrevious = async () => {
    const res = await fetch(
      process.env.REACT_APP_BACKEND_URL +
        `api/teachers/database?page=${page <= 0 ? 0 : page - 1}` +
        "&sortBy=" +
        sort +
        "&language=" +
        language +
  ...
  const IntermediateButtons = async (id) => {
    const res = await fetch(
      process.env.REACT_APP_BACKEND_URL +
        `api/teachers/database?page=${id + 1}` +
        "&language=" +
        language +
        "&subjects=" +
        subjects +
  ...
  const sorting = async (ascDesc) => {
    if (ascDesc === false) {
      const res = await fetch(
        process.env.REACT_APP_BACKEND_URL +
          "api/teachers/database?sortBy=asc" +
          "&language=" +
          language +
          "&subjects=" +
          subjects +
    ...
    if (ascDesc === true) {
      const res = await fetch(
        process.env.REACT_APP_BACKEND_URL +
          "api/teachers/database?sortBy=desc" +
          "&language=" +
          language +
          "&subjects=" +
          subjects +
        ...
        <section>
          <div className="fix-Container">
            <div className="row">
              ...
              {noOfCases.length === 0 ? (
                <div className="results">目前找到 0 位老師</div>
              ) : (
                <div className="results">目前找到 {noOfCases} 位老師</div>
              )}
            </div>
          </div>
        </section>
                  ...
                  <div className="row">
                    <div className="states_flex">
                      ...
                      <input
                        ...
                        value="海外"
                      />
                      <label htmlFor="int">海外</label>
                    </div>
                  </div>
                </div>
                <div className="modal-box-language">
                  <h2 style={{ margin: "0" }}>老師會的語言</h2>
                  <div className="row">
                    <div className="language_flex">
                      <input
                        ...
                        value="國語 中文"
                      />
                      <label htmlFor="mandarin">國語 中文</label>
                      <input
                        id="taiwanese"
                        type="checkbox"
                        ...
                        value="台語 閩南語"
                      />
                      <label htmlFor="taiwanese">台語 閩南語</label>
                      ...
                      <input
                        ...
                        value="日語"
                      />
                      <label htmlFor="japanese">日語</label>
                  ...
                  return (
                    <div className="tiles" key={teacher._id}>
                      <ExternalLink
                        ...
                        href={
                          process.env.REACT_APP_BACKEND_URL +
                          `api/teachers/resumeCandidate/${teacher.nanoId}/${teacher.slugId}`
                        }
                      >
                        <div className="topBox" style={{ overflow: "hidden" }}>
                          ...
                          >
                            ...
                            >
                              ...
                              <span
                                className={
                                  teacher.whichlanguage0 ? "blueSm" : ""
                                }
                              >
                                {teacher.whichlanguage0 &&
                                  teacher.whichlanguage0}
                              </span>
                              <span
                                className={
                                  teacher.whichlanguage1 ? "blueSm" : ""
                                }
                              >
                                {teacher.whichlanguage1 &&
                                  teacher.whichlanguage1}
                              </span>
                              <span
                                className={
                                  teacher.whichlanguage2 ? "blueSm" : ""
                                }
                              >
                                {teacher.whichlanguage2 &&
                                  teacher.whichlanguage2}
                              </span>
                            </div>
                          </div>
